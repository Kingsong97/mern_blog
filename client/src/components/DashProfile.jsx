                ...
                <form onSubmit={handleSubmit}>
                    <fieldset className="flex flex-col">
                        ...
                        <div className="flex justify-between mt-3 text-red-500">
                            <span className="cursor-pointer" onClick={() => setShowModal(true)}>계정 삭제</span>
                            <span className="cursor-pointer" onClick={handleSignout}>로그 아웃</span>
                        </div>
                    </fieldset>
                </form>
            </div>
            {showModal && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white rounded-lg p-8 w-full max-w-md text-center shadow-lg">
                        <h3 className="text-xl font-semibold mb-4">계정을 정말 삭제하겠습니까?</h3>
